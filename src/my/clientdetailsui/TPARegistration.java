 ...
 * @author kss
 */
public class TPARegistration extends javax.swing.JFrame {

    /**
     * Creates new form TPARegistration
     */
    public TPARegistration() {
        initComponents();
    }
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(clientName, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        ...
        try {
            int rs = stmt.executeUpdate("insert into TPA (TPAName,clientName,password,mobileNumber,accessTypeTPA) values ('" + userName.getText().trim() + "','"
                    + clientName.getText().trim() + "','"
                    + password.getText().trim() + "','"
                    + mobileNumber.getText().trim() + "','TPA' )");
            if (rs > 0) {
                {                  
                    ResultSet rs1=stmt.executeQuery("select * from clientdetails where uname= "
                    + "'" + clientName.getText()+"'");
                if(rs1.next())
                {
                ...
                {
                    JOptionPane.showMessageDialog(rootPane, "Please enter the correct client name");
                }
                }
            }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TPARegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TPARegistration().setVisible(true);
            }
        });
    }
